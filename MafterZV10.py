...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "targetip-geoip-ct334bomb-files-net", "https-targetip-geoip-ct334bomb-python3", "https://api-aktif-targetip-geoip-ct334-bomb-files-net", "api-targetip-geoip-ct334-bomb-files-net.org",
...
URLS = [
    ...
    #MalWareBytes
    ('https://api-aktif-targetip-geoip-ct334-bomb-files.net/aap.asp',
